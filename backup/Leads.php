...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha512-rhfMjOPwOFoNdmzsm5Dm32aribE20YpsWLCuKzO/ZuSLcJ+Qlo1uKX/yFN8bxg7v42A1Ft7ZO/UVZM3aXn9O6lQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
 ...
 <!--------------------------------------------popup form start--------------------------------------------------->        
         <div class="body flex-grow-1 px-3">
            ...
            <button class="openButton button" onclick="openForm()"><strong>Open Form</strong></button>
            <div class="loginPopup">
               <div class="formPopup" id="popupForm">
                  <form action="" method="post">
                     ...
                     <button class="cls_btn"onclick="closeForm()">Close</button>
...
<!-----------------------------------------------end popup form------------------------------------------>
         <?php
            ...
            if ($result->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>ID</th><th>Date</th><th>Employee Name</th><th>Customer Name</th><th>Email</th>
                <th>Phone</th><th>Interest</th><th>Comments</th><th>Edit</th><th>Remove</th></tr>";
